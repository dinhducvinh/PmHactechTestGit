                ...
                cmd.CommandText = """
                    SELECT
                        CASE WHEN
                            ...
                            OBJECT_ID(N'dbo.giohang_seed', N'U') IS NOT NULL AND
                            ...
                            COL_LENGTH(N'dbo.giohang_seed', N'cart_item_id_server') IS NOT NULL AND
                            COL_LENGTH(N'dbo.giohang_seed', N'buyer_tk_id_server') IS NOT NULL AND
                            COL_LENGTH(N'dbo.giohang_seed', N'sp_id_server') IS NOT NULL AND
                            COL_LENGTH(N'dbo.giohang_seed', N'so_luong') IS NOT NULL AND
                            EXISTS (SELECT 1 FROM sys.key_constraints WHERE parent_object_id = OBJECT_ID(N'dbo.giohang_seed') AND name = N'PK_giohang_seed') AND
                            ...
                            COL_LENGTH(N'dbo.thongbao_seed', N'tknhan_id_server') IS NOT NULL AND
                            COL_LENGTH(N'dbo.thongbao_seed', N'tkgui_id_server') IS NOT NULL AND
                            COL_LENGTH(N'dbo.thongbao_seed', N'tk_id_server') IS NULL AND
